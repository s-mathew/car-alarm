...
HD_PWD='/afs/athena.mit.edu/user/s/m/smathew/6.111work/labs/lab4/lab4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log labkit.vds -m64 -mode batch -messageDb vivado.pb -notrace -source labkit.tcl
